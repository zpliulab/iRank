...
RW=sparse(NR,NR);
RCS=sparse(NR,NR);
% join gene regulation information
...
length(find(RW>0))
% join miRNA regulation information 
...
normal_genes_all=intersect((D_num-0.2),(M_num-0.4));
...
std(Auc)
median(Auc)
save('RMD_3_33_new.mat','D','Auc','Normal_id','Normal_pr','Normal_rank','-v6')