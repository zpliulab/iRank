...
% construct CopyNnumberVariant ---->Regnetwork
...
Normal_id=[];
Circle=1000;
normal_genes_all=intersect((Reg_node-0.4),(C_num-0.1));
...
length(find(Auc<0.6))
std(Auc)
save('reg_c_33_new.mat','D','Auc','Normal_id','Normal_pr','Normal_rank','-v6')
