rm(list=ls())
library(R.matlab)#D
setwd("D:\\git_data\\procedure\\HCC_procedure\\information_integration\\ORIrmcs")
#data <- readMat("reg_s_33_new.mat")
#setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_mi_s_c")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
data <- readMat("RMSC_4_33_new.mat")
