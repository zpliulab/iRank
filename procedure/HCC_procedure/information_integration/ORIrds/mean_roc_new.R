...
#setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_d_s")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
setwd("D:\\git_data\\procedure\\HCC_procedure\\information_integration\\ORIrds")
data <- readMat("RDS_3_33_new.mat")
