...
setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_c_s")
setwd("D:/git_data/procedure/HCC_procedure/information_integration/ORIrcs")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
data <- readMat("RCS_3_33_new.mat")
