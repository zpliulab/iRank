...
setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_mi")
setwd("D:/git_data/procedure/HCC_procedure/information_integration/ORIrm")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
data <- readMat("reg_m_33_new.mat")
