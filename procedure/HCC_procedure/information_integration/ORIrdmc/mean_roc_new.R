...
#setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_d_mi_c")
setwd("D:/git_data/procedure/HCC_procedure/information_integration/ORIrdmc")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
data <- readMat("RMDC_4_33_new.mat")
