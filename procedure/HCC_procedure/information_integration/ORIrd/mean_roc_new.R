...
#setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_d")
setwd("D:/git_data/procedure/HCC_procedure/information_integration/ORIrd")
#data <- readMat("RDC_3_33_new.mat")
#setwd("I:\\shx_bioinformatics\\TCGA_Project\\Copy_of_reg_c")
data <- readMat("reg_d_33_new.mat")
