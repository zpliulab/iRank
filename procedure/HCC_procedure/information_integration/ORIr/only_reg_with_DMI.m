...
Auc=[];Normal_rank=[];Normal_pr=[];Normal_id=[];
Circle=1000;
normal_genes_all=Reg_node-0.4;
...
length(find(Auc<0.6))
std(Auc)
save('Reg_disease_33_new.mat','D','Auc','Normal_id','Normal_pr','Normal_rank','-v6')
% save reg_33
median(Auc)
