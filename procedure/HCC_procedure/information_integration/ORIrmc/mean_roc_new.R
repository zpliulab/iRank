...
setwd("D:/shx_bioinformatics/TCGA_Project/Copy_of_reg_mi_c")
#data <- readMat("RDC_3_33_new.mat")
setwd("D:\\git_data\\procedure\\HCC_procedure\\information_integration\\ORIrmc")
data <- readMat("RMC_3_33_new.mat")
