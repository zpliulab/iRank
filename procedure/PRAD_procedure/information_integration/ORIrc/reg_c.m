...
used_C=C_data.data(:,:);
% 创建CNV---->Regnetwork
C_num=intersect(unique(used_C(:,2)-0.3),(Reg_node-0.3))+0.1;%+0.3;
...
Normal_id=[];
Circle=1000;
normal_genes_all=intersect((Reg_node-0.3),(C_num-0.1));
...
min(Auc)
std(Auc)
save('reg_c_29.mat','D','Auc','Normal_id','Normal_pr','Normal_rank','-v6')
